...
import { AppContext } from "../utils/contexts/AppContext/AppContext"
...
const SidebarItem: React.FC<SidebarItemProps> = ({
  ...
  return (
    <div
      onClick={onClick}
      className={`flex items-center px-6 py-3 my-1 cursor-pointer ${
    ...
    >
      ...
      <span
        className={`text-base ${
          active ? "text-blue-500 font-medium" : "text-gray-700"
        }`}
      >
        {label}
      </span>
