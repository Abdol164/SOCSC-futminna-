...
const SetupComplete = () => {
  ...
  return (
    ...
    " 
    style={{
      backgroundImage: "linear-gradient(to bottom, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.6)), url('/png/brand.png')",
     ...
     >
      {/* Logo */}
      <div className="mb-8">
        <img src="/png/tiny.png" alt="Suimail Logo" className="w-12 h-12" />
      </div>
      ...
      <p className="text-gray-600 text-center mb-8 max-w-md">
        ...
        <span className="font-medium">{email}</span> has been created. You can
        now start using Suimail to send and receive encrypted messages.
      </p>

      {/* Key Features */}
      <div className="w-full max-w-md mb-8">
        <h2 className="text-lg font-medium text-gray-800 mb-4">
          What you can do with Suimail:
        </h2>
        <ul className="space-y-3">
          ...
          <li className="flex items-start">
            ...
            <span>
              Store your messages on the blockchain for maximum privacy
            </span>
          </li>
          <li className="flex items-start">
            <svg
      ...
      <div className="flex justify-center items-center mt-4">
        <Link
          ...
          className="px-7 py-2 rounded-lg w-50 text-white hover:bg-blue-700 transition-colors mb-4 text-center"
        >
          SignUp/Login
        </Link>
      </div>
