...
// import type { SponsorTxRequestBody } from "../../types/SponsorTx"
...
//       setName((decoded as { name: string }).name)
//       setEmailAddress((decoded as { email: string }).email)
//       setPicture((decoded as { picture: string }).picture)
...
//         const resp = await createSponsoredTx({
//           network,
//           txBytes: toBase64(txBytes),
//           sender: address!,
//           allowedAddresses,
